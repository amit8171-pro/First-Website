    ...
    <>
      <section className="seller">
        <div className="container">
          <h2 className='py-5 text-left fw-semibold fs-2'>Best Sellers. <span className='fs-2 text-secondary'>Best selling of the month</span></h2>
        <OwlCarousel className='owl-theme' loop margin={10} nav {...options}>
        {arrivals.slice(5,11).map((item)=>(
